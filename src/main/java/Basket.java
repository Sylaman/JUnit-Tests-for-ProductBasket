...
public class Basket {
    ...
    public void addToCart(int productNum, int amount) throws IllegalArgumentException {
        if (amount < 0) {
            throw new IllegalArgumentException("Количество товара не может быть отрицателььным");
        }
